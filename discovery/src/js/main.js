...
;(function(window) {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<div class="line-chevron-right">';
		...
		this.navRightCtrl.innerHTML = '<div class="line-chevron-left">';
	...
	CircleSlideshow.prototype._initEvents = function() {
		...
		// opening items
		this.items.forEach(function(item) {
			if (item.querySelector('.action--open')) {
